...
/* Huecos de comida — guía §7.4: pasar de 2 comidas a 3.
   135 g de proteína en dos comidas son casi 70 g de golpe: mucho volumen y
   difícil de sostener. Con tres, salen ~45 g por comida. */
window.COMIDAS = [
...
/* Objetivo de proteína por comida. Con 3 comidas y ~135 g diarios, 40 g es el
   listón por el que una comida se marca en verde. */
window.PROTE_COMIDA = 40;

/* Ideas de desayuno de la guía §7.4, para el que cuesta más: el que no existía. */
window.DESAYUNOS = [
  { n:"Rahka 250 g + puñado de frutos secos + fruta", prot:"30-35 g", tiempo:"1 min" },
  { n:"3 huevos revueltos + pan de centeno",          prot:"~25 g",   tiempo:"6 min" },
  { n:"Rahka + batido de proteína + avena",           prot:"~45 g",   tiempo:"3 min" }
];

/* Suplementos — guía §7.5. */
window.SUPLEMENTOS = [
  { id:"creatina", n:"Creatina monohidrato", dosis:"5 g", diario:true,
    nota:"Todos los días. También para mujeres: no retiene «agua que hincha» de forma visible ni te va a poner voluminosa." },
  ...
  { id:"whey",     n:"Batido de proteína",   dosis:"25-30 g", diario:false,
    nota:"Herramienta de conveniencia si no llegas al objetivo con comida." },
  { id:"hierro",   n:"Hierro",               dosis:"según receta", diario:false, ojo:true,
    nota:"SOLO si el análisis lo indica y bajo indicación médica. El hierro no se suplementa a ciegas: el exceso es tóxico y se acumula. Primero el análisis de hemoglobina y ferritina." }
];
